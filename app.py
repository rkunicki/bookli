...
def add_book():
    ...
    # published_date = datetime.strptime(request.form.get("publishedDate"), "%Y-%m-%d").date()
    ...
    all_books = [row.title for row in database]  # List of all books title from database by use comprehensive list
